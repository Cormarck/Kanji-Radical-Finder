...
import Auswahlflaeche from './components/auswahl';
import Uberschrift from './components/uberschrift';
import Radikalfilter from './components/filterRadikale';
import Kanjifilter from './components/filterKanji';
import KanjiAnsicht from './components/kanjiAnsicht';
...
.then(() => setKanjiAnsicht(<KanjiAnsicht text = {gefKanji}/>))
